...
// 	if (temp1 > temp2)
// 	{
// 		while(n > 0)// n != 0 (true), means stay in the loop
// 		{
// 			temp1[n - 1] = temp2[n - 1];// go backwards
// 			n--;
// 		}
// 	}
// 	// if my *dst is bigger than my *src
// 	// they probably overlap, but they shouldn't
// 	// to deal with it 
// 	// is better to start from the end and decrement both pointers
// 	// while n is true "move" my byte and decrement n
// 	else // means (temp1(dest) < temp2(src))
// 	{
// 		while (n)
// 		{
// 			// *++temp1 = *++temp2; WRONG
...
// 	int	n;
// 	// case 1: dst > src
// 	const char		src[] = "xyz"; // good to go
// 	char			dst[] = "abcdefghij"; // good to go

// 	// case 2: dst < src
// 	// const char		src[] = "abcdefghij"; // good to go
// 	// char			dst[] = "xyz"; // XXX
// 	// WRONG, buffer overflow unpredicted behavior
// 	// char			dst[sizeof(src)] = {0}; // good to go
// 	// REMEMBER, assure that you are giving enough memo for dst
// 	// sizeof() only work for a literal array. arr[] = "words..."
// 	// is enough for make tests
// 	// try to make simple, you could just use a fixed number. "arr[50];"
// 	// REMEMBER to avoid trash. arr[] = {0}.
